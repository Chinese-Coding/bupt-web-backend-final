...
public class OrderListener {
    ...
    public void handleOrder(String orderMessage) {
        try {
            ...
            var order = objectMapper.convertValue(orderMap.get("order"), Order.class);
            ...
            for (var orderItem : orderItems) {
                ...
                var curProduct = productService.getById(productId);
    ...
    public void handlePayment(String orderMessage) {
        ...
        try {
            ...
            var updated = orderService.updateById(order);
            if (updated) {
